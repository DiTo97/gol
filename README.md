...
- `mpi`, stands for binaries in which MPI support has been enabled, thus they should be launched following standard MPI commands structure, i.e., `mpirun` or `mpiexec`;
